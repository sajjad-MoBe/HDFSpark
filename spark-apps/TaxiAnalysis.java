...
public class TaxiAnalysis {
    ...
    public static void main(String[] args) {
        ...
        String outputPath = "../data/output"; // Will write to your local 'spark-apps/output'
        ...
        // Load datasets using the exact filenames from your 'data' directory
        ...
        // Add calls to other analysis functions here if needed
